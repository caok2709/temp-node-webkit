...
define(['./app'],function(app){
    ...
    app.service('customersService', function () {
        ...
        this.insertCustomer = function (firstName, lastName, city, address) {
        ...
        var customers = [
            {
                id: 1, firstName: 'Kuan', lastName: 'Cao', address: '320 23rd St South', city: 'Arlington',
                orders: [
                    { product: 'Macbook Pro', price: 2100.99, quantity: 1, orderTotal: 2100.99 }
                ]
            },         
            {
                id: 2, firstName: 'Victor', lastName: 'Bryan', address: '563 N. Rainier St.', city: 'Seattle',
                orders: [
            ...
            {
                id: 4, firstName: 'Jesse', lastName: 'Hawkins', address: '89 W. Center St.', city: 'Atlanta',
                orders: [
            ...
            {
                id: 5, firstName: 'Charles', lastName: 'Sutton', address: '455 7th Ave.', city: 'Quebec',
                orders: [
            ...
            {
                id: 6, firstName: 'Albert', lastName: 'Einstein', address: '8966 N. Crescent Dr.', city: 'New York City',
                orders: [
            ...
            {
                id: 7, firstName: 'Sonya', lastName: 'Williams', address: '55 S. Hollywood Blvd', city: 'Los Angeles'
            },

            {
                id: 8, firstName: 'Lynette', lastName: 'Gonzalez', address: '25624 Main St.', city: 'Albuquerque',
                orders: [
            ...
            {
                id: 9, firstName: 'Erick', lastName: 'Pittman', address: '33 S. Lake Blvd', city: 'Chicago',
                orders: [
            ...
            {
                id: 10, firstName: 'Alice', lastName: 'Price', address: '3354 Town', city: 'Cleveland',
                orders: [
            ...
            },
            {
                ...
                id: 11, firstName: 'Gerard', lastName: 'Tucker', address: '6795 N. 53 W. Bills Dr.', city: 'Buffalo',
                orders: [
            ...
            {
                id: 12, firstName: 'Shanika', lastName: 'Passmore', address: '459 S. International Dr.', city: 'Orlando'
            }
        ];
    });
    }
